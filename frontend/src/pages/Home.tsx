      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="group relative bg-white rounded-lg overflow-hidden shadow-md transition-all duration-300 hover:shadow-lg border border-gray-200">
            ...
            <div className="p-6">
              <p className="text-gray-600 mb-6">
                High-torque motors with exceptional durability and precision
          ...
          <div className="group relative bg-white rounded-lg overflow-hidden shadow-md transition-all duration-300 hover:shadow-lg border border-gray-200">
            ...
            <div className="p-6">
              <p className="text-gray-600 mb-6">
                Powerful winches engineered for reliability in extreme
                conditions with superior pulling capacity.
              </p>
              <div className="flex justify-between items-center">
                <Link
                  to="/products"
          ...
          <div className="group relative bg-white rounded-lg overflow-hidden shadow-md transition-all duration-300 hover:shadow-lg border border-gray-200">
            ...
            <div className="p-6">
              <p className="text-gray-600 mb-6">
                Precision-engineered reducers for optimal torque and efficiency
                ...
                <div className="relative">
                  ...
                  <div className="space-y-4 text-gray-700">
                    <p>
                      ...
                      technical innovation to help you maintain a competitive
                      edge.
                    </p>
                    <p>
                      Working closely with our distributors and world-class
                      OEMs, we provide cost-effective, high-performance
                      hydraulic components that exceed industry standards. Our
                      manufacturing facilities in China are equipped with
                      state-of-the-art technology and staffed by skilled
                    ...
                    <p>
                      ...
                      manufacturer you can trust to deliver solutions that
