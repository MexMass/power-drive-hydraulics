...
const slides = [
  {
    url: "/images/hero_motor.jpeg?height=600&width=1200&text=Hydraulic+Motors",
    title: "High-Performance Hydraulic Motors",
    description:
      "Engineered for reliability in the most demanding industrial applications",
  },
  {
    url: "/images/hero_hydraulic_winch.jpeg?height=600&width=1200&text=Hydraulic+Winches",
    title: "Heavy-Duty Hydraulic Winches",
    description: "Superior pulling power with precision control systems",
  },
  {
    url: "/images/hero_gear_reducer.jpeg?height=600&width=1200&text=Gear+Reducers",
    title: "Precision Gear Reducers",
    description:
      "Optimized for efficiency and durability in challenging environments",
  },
];
